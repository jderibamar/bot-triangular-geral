    ...
    public loadData() 
    {
      ...
      {          
          ...
          let todasExcs = [],
              ...
              graviex = await this.triS.graviextUsdtBtc(),
              bigOne = await this.triS.bigOnetUsdtBtc(),
              // azbit = await this.triS.azBitUsdtBtc(),
              bitMart = await this.triS.bitMartUsdtBtc()
  
          todasExcs.push
          (
             ...fmfw, ...bittrex, ...gate, ...poloniex, ...bitMart, ...graviex, ...bigOne
          )
